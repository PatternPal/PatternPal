...
namespace IDesign.Recognizers.Recognizers
{
    public class StateRecognizer : IRecognizer
    {
        ...
        public IResult Recognize(IEntity node)
        {
            ...
            var statePatternCheck = new GroupCheck<IEntity, IEntity>(new List<ICheck<IEntity>>
            {
                ...
                {
                    new ElementCheck<IEntity>(x => x.CheckMinimalAmountOfRelationTypes(RelationType.UsedBy, 1), "NodeUses1", 0.5f),
                ...
                //check inheritance
                 new GroupCheck<IEntity, IEntity>(new List<ICheck<IEntity>>
                 {
                        new ElementCheck<IEntity>(x => {entityNode = x; return x.GetAllMethods().Any(); }, "MethodAny"),
