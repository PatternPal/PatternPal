            ...
            var factoryMethodChecks = new GroupCheck<IEntity, IEntity>(
                new List<ICheck<IEntity>>
                {
                    ...
                    new ElementCheck<IEntity>(
                        x => x.CheckTypeDeclaration(EntityType.Class) && x.CheckModifier("abstract"),
                        "NodeModifierAbstract", 2
                    ),
                    new ElementCheck<IEntity>(
                        x => x.CheckMinimalAmountOfRelationTypes(RelationType.Uses, 1), "NodeUses1",
                        1
                    ),
                        ...
                        new List<ICheck<IEntity>>
                        {
                            ...
                            new GroupCheck<IEntity, IMethod>(
                                new List<ICheck<IMethod>>
                                {
                                    ...
                                    new ElementCheck<IMethod>(
                                        x => x.CheckModifier("abstract"), "MethodModifierAbstract",
                                        1
                                    ),
                                    new ElementCheck<IMethod>(
