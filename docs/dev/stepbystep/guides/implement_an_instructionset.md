...
In order to make effective use of existing @PatternPal.Core.Recognizers for both detecting patterns and Step-By-Step 
...
that need to pass in a step. These can be added to a list of instruction in `GenerateStepsList`. An example would be :
